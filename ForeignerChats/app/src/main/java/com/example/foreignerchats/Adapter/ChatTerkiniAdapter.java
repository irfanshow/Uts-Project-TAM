...
public class ChatTerkiniAdapter extends FirebaseRecyclerAdapter<ModelSemua, ChatTerkiniAdapter.SemuaViewHolder> {

    public ChatTerkiniAdapter(@NonNull FirebaseRecyclerOptions<ModelSemua> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull SemuaViewHolder holder, int position, @NonNull ModelSemua model) {
        ...
        Glide.with(holder.photo.getContext())
                ...
                .into(holder.photo);
        holder.chatterakhir.setText(model.getPesanterakhir());
    ...
    public class SemuaViewHolder extends RecyclerView.ViewHolder {
        ...
        public SemuaViewHolder(@NonNull View itemView) {
            ...
            chatterakhir = itemView.findViewById(R.id.chatterakhir);
